...
<?PHP
 ...
 $mail = new PHPMailer(); 	 // Eposta HTML olarak gonderilsin (HTML gonderimini iptal etmek icin true yerine false yazin)
 $mail->IsHTML(true);
...
/* $mail->AltBody = "Teklif Formu\n\n
 ...
 $mail->Username = "teklif@cgnyazilim.com";
 $mail->Password = "027TEK951lif";

 // Eposta kimden gidiyor?
 $mail->From = "teklif@cgnyazilim.com";

 // Eposta icin gorunen isim (Opsiyonel)
 //$mail->FromName = "Teknik Destek";

 // hedef adres (gorunen isim olmadan)
 $mail->AddAddress("teklif@cgnyazilim.com");
